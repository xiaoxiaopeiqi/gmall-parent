package com.atguigu.gmall.gmallmbg;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\JavavVideo\\gmall\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("Dxj");
        ...
        dsc.setUrl("jdbc:mysql://192.168.75.131:3316/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
